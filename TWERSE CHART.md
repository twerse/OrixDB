...
## 1. Preamble
This charter defines the governance structure, contributor rights, continuity mechanisms, and succession rules of **Twerse inc.**, the corporation owning licenses and trademarks related to **RSON** and **OrixDB**.

---

## 2. Governance and Ownership
- **9280-4061 Québec inc.** holds **100% of decision-making power** within Twerse inc.  
...
- The **49% pool** applies to **all net revenues generated by Twerse inc.**, including tools, services, partnerships, and other activities.  
...
- Categories of collaborators eligible include, but are not limited to:  
  ...
  - **Future categories** as defined by Twerse inc.  
...
- The Buyout Price shall be calculated according to Section 6.2.  
- Payment shall be made following the same rules as in Section 6.3 and 6.4.  
...
## 12. Warranty
Twerse inc. guarantees the continuity of the project, without contractual obligations to individual contributors beyond the rules defined herein.  
